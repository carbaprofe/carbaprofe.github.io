...
tags: [electricidad, componentes, simbología, esquemas, ESO]
fecha: 2026-07-06
---
...
Un esquema es un idioma visual, igual que las señales de tráfico. No necesitas saber español para entender que un triángulo rojo significa peligro — y no necesitas hablar el mismo idioma que el ingeniero que dibujó un circuito en otro país para entender que ese círculo con una X es una bombilla.
...
- [Aprendemos Tecnología — Tema 3: Electricidad, 2º ESO](https://aprendemostecnologia.org/wp-content/uploads/2013/06/electricidad-2eso.pdf) — PDF con tablas de simbología, en español
- [PhET — Kit de Construcción de Circuitos: CD](https://phet.colorado.edu/es/simulations/circuit-construction-kit-dc) — verás estos símbolos en acción al construir tus propios circuitos
